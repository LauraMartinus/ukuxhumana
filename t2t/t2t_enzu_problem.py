...
DATA_DIR = os.path.expanduser("/tmp/t2t/enzu/data")
OUTPUT_DIR = os.path.expanduser("/tmp/t2t/enzu/output")
TMP_DIR = os.path.expanduser("/tmp/t2t/enzu/tmp")
